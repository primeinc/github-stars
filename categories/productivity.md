...
| [openclaw/clawhub](https://github.com/openclaw/clawhub) | Skill Directory for Open Claw | `TypeScript` ★ 6.6k | 2026-03-23 |
...
| [aiming-lab/AutoResearchClaw](https://github.com/aiming-lab/AutoResearchClaw) | Fully autonomous & self-evolving research from idea to paper. Chat an Idea. Get a Paper. 🦞 | `Python` ★ 7.7k | 2026-03-23 |
...
| [HKUDS/CLI-Anything](https://github.com/HKUDS/CLI-Anything) | CLI-Anything: Making ALL Software Agent-Native | `Python` ★ 21.4k | 2026-03-22 |
...
| [readest/readest](https://github.com/readest/readest) | Readest is a modern, feature-rich ebook reader designed for avid readers offering seamless cross-platform access, powerful tools, and an intuitive interface to elevate your reading experience. | `TypeScript` ★ 18.9k | 2026-03-22 |
...
| [zed-industries/zed](https://github.com/zed-industries/zed) | Code at the speed of thought – Zed is a high-performance, multiplayer code editor from the creators of Atom and Tree-sitter. | `Rust` ★ 77.7k | 2026-03-23 |
| [ToolJet/ToolJet](https://github.com/ToolJet/ToolJet) | Tool Jet is the open-source foundation of Tool Jet AI - the AI-native platform for building internal tools, dashboard, business applications, workflows and AI agents 🚀 | `JavaScript` ★ 37.6k | 2026-03-22 |
...
| [cyanheads/obsidian-mcp-server](https://github.com/cyanheads/obsidian-mcp-server) | Obsidian Knowledge-Management MCP (Model Context Protocol) server that enables AI agents and development tools to interact with an Obsidian vault. It provides a comprehensive suite of tools for rea... | `TypeScript` ★ 415 | 2025-10-24 |
...
| [negokaz/excel-mcp-server](https://github.com/negokaz/excel-mcp-server) | A Model Context Protocol (MCP) server that reads and writes MS Excel data | `Go` ★ 892 | 2025-07-19 |
...
| [HKUDS/MoChat](https://github.com/HKUDS/MoChat) | "Mo Chat: Open Claw as Your Social Agent https://mochat.io" | `TypeScript` ★ 214 | 2026-02-12 |
| [maxritter/pilot-shell](https://github.com/maxritter/pilot-shell) | The professional development environment for Claude Code: From requirement to production-grade code. Planned, tested, verified. | `TypeScript` ★ 1.6k | 2026-03-22 |
