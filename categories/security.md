...
| [matijazezelj/sib](https://github.com/matijazezelj/sib) | SIEM in a box | `Python` ★ 58 | 2026-01-09 |
...
| [dani-garcia/vaultwarden](https://github.com/dani-garcia/vaultwarden) | Unofficial Bitwarden compatible server written in Rust, formerly known as bitwarden_rs | `Rust` ★ 53.3k | 2026-01-09 |
...
| [x011/smtp-tunnel-proxy](https://github.com/x011/smtp-tunnel-proxy) | A high-speed covert tunnel that disguises TCP traffic as SMTP email communication to bypass Deep Packet Inspection (DPI) firewalls. | `Python` ★ 894 | 2026-01-07 |
...
| [OneKeyHQ/app-monorepo](https://github.com/OneKeyHQ/app-monorepo) | Secure, open source and community driven crypto wallet runs on all platforms and trusted by millions. | `TypeScript` ★ 2.2k | 2026-01-12 |
...
| [kaifcodec/user-scanner](https://github.com/kaifcodec/user-scanner) | Scan a username across multiple social, developer, gaming and creator platforms to see if it’s available. Perfect for finding a unique username for your personal profile or business across Git Hub,... | `Python` ★ 329 | 2026-01-10 |
...
| [WerWolv/ImHex](https://github.com/WerWolv/ImHex) | 🔍 A Hex Editor for Reverse Engineers, Programmers and people who value their retinas when working at 3 AM. | `C++` ★ 52.2k | 2026-01-12 |
...
| [amnezia-vpn/amnezia-client](https://github.com/amnezia-vpn/amnezia-client) | Amnezia VPN Client (Desktop+Mobile) | `C++` ★ 9.5k | 2026-01-12 |
...
| [fosrl/pangolin](https://github.com/fosrl/pangolin) | Identity-aware VPN and proxy for remote access to anything, anywhere. | `TypeScript` ★ 17.9k | 2026-01-12 |
...
| [netbirdio/netbird](https://github.com/netbirdio/netbird) | Connect your devices into a secure Wire Guard®-based overlay network with SSO, MFA and granular access controls. | `Go` ★ 21k | 2026-01-11 |
...
| [ente-io/ente](https://github.com/ente-io/ente) | 🔥 End-to-end encrypted cloud for everything. | `Dart` ★ 23.8k | 2026-01-12 |
...
| [gravitational/teleport](https://github.com/gravitational/teleport) | The easiest, and most secure way to access and protect all of your infrastructure. | `Go` ★ 19.6k | 2026-01-12 |
